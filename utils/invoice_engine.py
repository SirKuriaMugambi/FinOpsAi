...
def process_invoice(
    ...
    WHT is calculated on the base amount (before VAT) — 2% general
    goods/contractual, 5% professional/consultancy.
    ...
    # WHT calculation — on subtotal/base, not including VAT
